...
- Today: current HealthKit weight state, latest review focus, goal progress, due habits, actionable priority tasks with due-date/list/project/goal context, same-day Google Calendar blocks, and nutrition status.
...
- Review: daily reflection that turns next focus into a priority task, plus weekly keep/change/focus/commitment review.
